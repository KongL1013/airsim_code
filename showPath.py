...
def send(flag):
	...
	while True:
		...
		client.moveToPositionAsync(float(2000.00), float( 0), float( -45), float(10))
		if(wait(200, flag)):
			break

		client.moveByAngleZAsync(float(0.0), float(0.0), float(-45), float(-1.57), float(10))
		if(wait(5, flag)):
			break

		client.moveToPositionAsync(float(2000.00), float( -400), float( -45), float( 10))
		if(wait(200, flag)):
			break
		...
		client.moveToPositionAsync(float(0.0), float( -400), float( -45), float( 10))
		wait(200, flag)
		...
		client.moveToPositionAsync(float(0.0), float(0), float( -45), float( 10))
		if(wait(200, flag)):
			break
